...
public class RookiesController : Controller
{
   ...
   static IList<Person> _people = new List<Person>
    {
        new Person(1,"Nguyen Van", "Nam", "Nam", new DateTime(1999, 06, 02), "0945628812", "Nam Dinh"),
        new Person(2,"Do Tuan", "Duc", "Nam", new DateTime(2000, 11, 08), "0938428762", "Ha Noi"),
        new Person(3,"Hoang Thanh", "Huong", "Nu", new DateTime(2002, 4, 20), "0948348712", "VietNam")
    };
  ...
  {
      return Content($"This is Person: {model.FirstName} {model.LastName}, Birth Place : {model.BirthPlace}");
  }
  public ActionResult Edit(int id)
  {
      var person = _people.Where(s => s.Id == id).FirstOrDefault();
